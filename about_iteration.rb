...
class AboutIteration < Neo::Koan
  ...
  def test_find_locates_the_first_element_matching_a_criteria
    ...
    assert_equal "Clarence", array.find { |item| item.size > 4 } # larger than 4 characters
  end
  ...
  def test_inject_will_blow_your_mind
    ...
    # whatever is in the array, accumlates depending on what method i.e. add, multiple, etc.
  end
  ...
  #     # code to read 'file'
  # this way it will close it for you
  # open, right to it, then close
  #   end
  #
  ...
  #   # code to read 'file'
  # have to manually close the file yourself
  #
