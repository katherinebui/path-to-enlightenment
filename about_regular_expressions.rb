...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
  # because it will consume as much as possible?
  ...
  def test_shortcut_character_classes_are_negated_with_capitals
    ...
    assert_equal " = ", "variable_1 = 42"[/[^a-zA-Z0-9_]+/] # wtf is going on here
  ...
  def test_slash_a_anchors_to_the_start_of_the_string
    assert_equal "start", "start end"[/\Astart/] # start before end
    assert_equal nil, "start end"[/\Aend/] # nothing before start
  end

  def test_slash_z_anchors_to_the_end_of_the_string
    assert_equal "end", "start end"[/end\z/] # end of the string = end
    assert_equal nil, "start end"[/start\z/] # there is nothing after end
  end

  def test_caret_anchors_to_the_start_of_lines
    assert_equal "2", "num 42\n2 lines"[/^\d+/] # beginning of line after /n (new line)
  end

  def test_dollar_sign_anchors_to_the_end_of_lines
    assert_equal "42", "2 lines\nnum 42"[/\d+$/] # end of line after /n
  end
  ...
  # (.|\n) matches any character, [.\n] matches either a literal dot or a newline.
  # Character classes ([...]) are optimized for matching one out of some set of characters
  # and alternatives (x|y) allow for more general choices of varying lengths.
